...
class Cluster(_messages.Message):
  ...
  mainAuth = _messages.MessageField('MainAuth', 27)
  mainAuthorizedNetworksConfig = _messages.MessageField('MainAuthorizedNetworksConfig', 28)
  mainIpv4CidrBlock = _messages.StringField(29)
